...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        position (int, int): defines the position of the new square.
        """
        self.size = size
    ...
    @property
    def size(self):
        """This method gets/sets the current size of the square."""
        return (self.__size)
    ...
    @property
    def position(self):
        """This method Gets/sets the current position of
        the square.
        """
